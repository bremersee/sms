...
public abstract class AbstractSmsService implements SmsService {
   ...
   *
   * @param defaultSender the default name or number of the sender (legal characters are a-z, A-Z
   *                      and 0-9)
   */
   ...
   *
   * @param defaultReceiver the default name or number of the receiver (legal characters are a-z,
   *                        A-Z and 0-9)
   */
  ...
  @Override
  public SmsSendResponseDto sendSms(final String sender, final String receiver,
  ...
  /**
   * Returns the sender of the request. If no sender is specified the default sender will be
   * returned.
   *
  ...
  /**
   * Returns the receiver of the request. If no receiver is specified the default receiver will be
   * returned.
   *
   * @param smsSendRequestDto the sms request
   * @return the receiver
  ...
  /**
   * Returns the message of the request. If no message is specified the default message will be
   * returned.
   *
   * @param smsSendRequestDto the sms request
   * @return the message
